...
- **Body**: Steps to reproduce, expected vs actual behavior, logs/screenshots
...
- Python: Follow PEP 8
- JavaScript: Use 2-space indent, single quotes
- Shell scripts: Include `set -e` for error handling
